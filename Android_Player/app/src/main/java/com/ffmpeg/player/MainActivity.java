...
import com.panda.live.LiveManager;
import com.panda.live.list.LiveList;
import com.panda.live.room.Room;
import com.panda.live.room.Videoinfo;
...
public class MainActivity extends RxAppCompatActivity implements TabLayout
    ...
    public void onTabSelected(TabLayout.Tab tab) {
        //请求获取房间 todo 显示加载等待
        Log.d("HONGTAI", "onTabSelected tab=" + tab.getTag().toString());
        LiveManager.getInstance()
                ...
                .subscribe(new DisposableSubscriber<LiveList>() {
                    ...
                    public void onNext(LiveList liveList) {
                        Log.d("HONGTAI", "onNext liveList=" + liveList);
